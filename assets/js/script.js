...
let hoursObjArray = [
    {hour:"9AM",description:""},
    {hour:"10AM",description:""},
    {hour:"11AM",description:""},
    {hour:"12PM",description:""},
    {hour:"1PM",description:""},
    {hour:"2PM",description:""},
    {hour:"3PM",description:""},
    {hour:"4PM",description:""},
    {hour:"5PM",description:""}];
...
for (let i = 0; i < hoursArray.length; i++){
    let thisHourNumOnly = hoursArray[i].slice(0,-1).slice(0,-1).trim();
    $(".container").append("<div class='row' data-hour='" + thisHourNumOnly + "'><div class='col-1'></div><div class='col-1 hour'>" + hoursArray[i] + "</div><div class='col-7 bg-dark description'></div><div class='col-1 saveBtn'></div><div class='col-1'></div></div>");
};
